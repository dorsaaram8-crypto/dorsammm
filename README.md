...
Complexity Exercises
Description
Exercises for calculating time complexity of various loop structures.
...
...
Code Breakdown
Ex 1: Simple loop. F(n) = 2n + 2.
Ex 6: Nested loops. F(n) = 3n^2 + 4n - 8.
Ex 7: Loop with step 3.
Ex 9: Triangular loop (i to n). Sum is n(n+1)/2.
